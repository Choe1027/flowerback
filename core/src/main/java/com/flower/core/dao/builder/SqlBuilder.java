package com.flower.core.dao.builder;


import com.flower.common.annotation.Ignore;
import com.flower.common.annotation.Table;
import com.flower.common.exception.SysException;
import com.flower.common.excutor.Filter;
import com.flower.common.utils.LoggerUtil;
import com.flower.common.utils.ObjectUtil;
...
public class SqlBuilder {
    ...
    public static String buildUpdateSql(Object object) throws Exception {
        ...
        if (ObjectUtil.getAttributeValue(object, "id") == null) {
            throw new SysException("修改操作中，id不能为空");
        }
        tableSql.delete(tableSql.lastIndexOf(","), tableSql.lastIndexOf(",") + 1);
